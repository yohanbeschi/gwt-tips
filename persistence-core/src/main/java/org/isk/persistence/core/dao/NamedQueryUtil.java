...
public class NamedQueryUtil {
    ...
    public Object objectByNamedQuery(SearchParameters searchParameters) {
        ...
        if (log.isDebugEnabled()) {
            log.debug(searchParameters.getNamedQuery() + " returned a " + (result == null ? "null" : result.getClass())
                    + " object");
